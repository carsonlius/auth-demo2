package com.carsonlius.framework.web.core.handler;
...
import com.carsonlius.framework.web.core.service.ApiErrorLog;
...
//    private final ApiErrorLogFrameworkService apiErrorLogFrameworkService;
    ...
    public CommonResult<?> accessDeniedExceptionHandler(HttpServletRequest req, AccessDeniedException ex) {
        log.warn("[accessDeniedExceptionHandler][userId({}) 无法访问 url({})]", req.toString(),
